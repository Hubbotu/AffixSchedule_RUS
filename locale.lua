...
langs.ruRU = {
	...
	config_progressFormat_5 = "90/372 (282)",
	config_progressFormat_6 = "24.19% (75.81%) - 90/372 (282)",
	config_splitsFormat = "Промежуточное отображение целей",
	config_splitsFormat_1 = "Отключено",
	config_splitsFormat_2 = "Время с начала",
	config_splitsFormat_3 = "По сравнению с предыдущим",
	config_autoGossip = "Автоматически выбирать варианты разговора во время подземелий с ключом (например, Odyn)",
	config_silverGoldTimer = "Показывать таймер для 2 и 3 бонусных сундуков одновременно",
	config_completionMessage = "Показывать сообщение с последним временем после прохождения подземелья с эпохальным ключом",
	config_showSplits = "Показывать промежуточное время для каждой цели в трекере целей",
	keystoneFormat = "[Ключ: %s - Уровень %d]",
	completion0 = "Таймер истек для %s с %s, вы превысили лимит времени на %s.",
	completion1 = "Пройдите вовремя на %s в %s. Вы опередили таймер на %s и опоздали на +2 на %s.",
	completion2 = "Пройдите вовремя на +2 %s в %s. Вы опередили таймер +2 на %s и опоздали на +3 на %s.",
	completion3 = "Пройдите вовремя на +3 %s в %s. Вы были на %s впереди таймера +3.",
	completionSplits = "Разделенное время: %s.",
	timeLost = "Потерянное время",
	config_smallAffixes = "Уменьшите размер значков аффиксов в окне оставшегося времени",
	config_deathTracker = "Отображать смерти в окне оставшегося времени",
	scheduleTitle = "График",
	scheduleWeek1 = "Эта неделя",
	scheduleWeek2 = "Следующая неделя",
	scheduleWeek3 = "В течение двух недель",
	scheduleWeek4 = "В течение трех недель",
	scheduleMissingKeystone = "Для отображения требуется эпохальный ключ 7+ уровня в вашем инвентаре.",
	scheduleUnknown = "Обновленное расписание аффиксов в настоящее время неизвестно.",
	config_hideTalkingHead = "Скрыть диалог Говорящей головы в подземелье с эпохальным ключом",
	config_resetPopup = "Показывать всплывающее окно для сброса подземелья после выхода из завершенного подземелья с эпохальным ключом",
	partyKeysTitle = "Ключи в группе",
	newKeystoneAnnounce = "Новый ключ: %s",
	currentKeystoneText = "Текущий: |cFFFFFFFF%s|r",
	config_announceKeystones = "Сообщить своей группе о только что полученном эпохальном ключе",
}
